...
public class Order {
  ...
  public static void main(String[] args) throws InterruptedException {
	  System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\afife\\OneDrive\\Documents\\selenium dependencies\\drivers\\chromedriver.exe");
    ...
    driver.findElement(By.linkText("Order")).click(); // other way

    Random rd = new Random();
    int num = rd.nextInt(100 -1)+1;

    driver.findElement(By.name("ctl00$MainContent$fmwOrder$txtQuantity")).sendKeys("" + num);
//    driver.findElement(By.name("ctl00$MainContent$fmwOrder$txtQuantity")).sendKeys(String.valueOf(num));
